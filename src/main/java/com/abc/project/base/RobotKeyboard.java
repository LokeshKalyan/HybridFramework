...
/**
 * @author pmusunuru2
 * @since Jun 16, 2021 3:20:19 pm
 */
public class RobotKeyboard 
{
	private Robot robot;

	public RobotKeyboard() throws Exception {
	...
	public static Robot createRobot() throws Exception {
	...
	public void type(char character) throws Exception {
		switch (character) {
		case 'a':
		...
		case ' ':
			...
			break;
		default:
			throw new Exception("Cannot type character " + character);
		}
	}
